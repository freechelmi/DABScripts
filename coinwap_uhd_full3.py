...
# Generated: Tue Dec 27 21:06:15 2011
##################################################
...
class coinwap_uhd_full3(grc_wxgui.top_block_gui):
  ...
  def __init__(self, subdev="A:0", devid="type=usrp1", frequency=216928000, ant="TX/RX", gain=10, enable_filter=0, rate=3.2e6):
		...
		self.connect((self.blks2_valve_1_0, 0), (self.gr_multiply_const_vxx_0, 0))
...
if __name__ == '__main__':
	...
	parser.add_option("-a", "--devid", dest="devid", type="string", default="type=usrp1",
	...
	tb = coinwap_uhd_full3(subdev=options.subdev, devid=options.devid, frequency=options.frequency, ant=options.ant, gain=options.gain, enable_filter=options.enable_filter, rate=options.rate)
	tb.Run(True)
